          ...
          {rooms.map((room, i) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-slate-50 border border-slate-200 hover:border-ocean-deep/50 rounded-sm overflow-hidden flex flex-col justify-between shadow-xs hover:shadow-xl transition-colors transition-shadow duration-300"
              >
                <div>
